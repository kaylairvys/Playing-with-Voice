...
alpha_alt = 'apple bat cap drum each fine gust harp sit jury crunch look made near odd pit quench red sun trap urge vest whale plex yank zip'.split()
...
def get_turtle_functions(m):
    try:
        return [turtle_functions[func] for func in m['basic_keys.turtle_functions']]
    except KeyError:
        return []
